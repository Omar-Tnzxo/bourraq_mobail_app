  ...
  void _useFallbackScreens() {
    _screens = [
      ...
      OnboardingScreenModel(
        ...
        descriptionAr: 'استلم طلباتك في أقل من 30 دقيقة',
        descriptionEn: 'Receive your orders in less than 30 minutes',
        displayOrder: 2,
      ),
      OnboardingScreenModel(
        id: '3',
        ...
        descriptionAr: 'تابع طلبك لحظة بلحظة حتى يصل إليك',
        descriptionEn: 'Track your order live until it reaches you',
        displayOrder: 3,
      ),
    ];
    setState(() {});
